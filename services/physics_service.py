...
PHYSICS_ENGINE_PATH = Path(__file__).parent.parent / "physics_engine"
...
class PhysicsService:
    ...
    def run_simulation(
        ...
        Args:
            ...
            custom_mass_kg: Optional custom mass override in kilograms
        ...
        # Get scaled properties from performance calculator
        scaled_length, scaled_frontal_area, _ = perf_calc._get_scaled_properties(
        ...
        drag_force = 0.5 * 1.225 * (wind_speed_ms ** 2) * cd_at_speed * scaled_frontal_area
